...
man_pages = [
    ('index', 'fuel-plugin-openbook', u'Guide to the Openbook Plugin ver. 1.0.0 for Fuel',
     [u'Talligent Inc.'], 1)
]
...
texinfo_documents = [
  ('index', 'fuel-plugin-openbook', u'The Openbook Plugin for Fuel Documenation',
   u'Talligent Inc.', 'fuel-plugin-openbook', 'The Openbook Plugin for Fuel Documenation',
   'Miscellaneous'),
]
